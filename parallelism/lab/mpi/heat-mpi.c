...
int main( int argc, char *argv[] )
{
    ...
    if (myid == 0) {
        ...
        // Consider Bcast and Scatter (the current structure is not suitable)
        ...
        /* MPI_Gather(&u, qtt, MPI_DOUBLE, */
        /*            &param.u, numprocs*qtt, MPI_DOUBLE, */
        /*            0, MPI_COMM_WORLD */
        /*           ); */
